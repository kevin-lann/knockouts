...
export default function Logo() {
  return (
    <div className='flex gap-8 items-center mb-8 text-6xl font-extrabold [-webkit-text-stroke:2px_black] [paint-order:stroke_fill] drop-shadow-[4px_4px_0_var(--foreground)]'>
      <h1
